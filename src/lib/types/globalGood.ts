...
import { CoreMetadata } from './globalGood/coreMetadata';
import { Classifications } from './globalGood/classifications';
import { StandardsAndInteroperability } from './globalGood/standardsAndInteroperability';
import { ProductOverview } from './globalGood/productOverview';
import { Reach } from './globalGood/reach';
import { Maturity } from './globalGood/maturity';
import { ClimateAndHealthIntegration } from './globalGood/climateAndHealthIntegration';
import { Community } from './globalGood/community';
import { InclusiveDesign } from './globalGood/inclusiveDesign';
import { EnvironmentalImpact } from './globalGood/environmentalImpact';
import { TotalCostOfOwnership } from './globalGood/totalCostOfOwnership';
import { Sustainability } from './globalGood/sustainability';
import { Resources } from './globalGood/resources';
import { LinkedInitiatives } from './globalGood/linkedInitiatives';
